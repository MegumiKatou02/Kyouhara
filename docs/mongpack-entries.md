...
**Trạng thái: ĐÃ DUYỆT phần bố cục; hai mục ⚠ chờ chốt.**
...
| (chưa dùng) | `Plugin` (5) | ⬜ | Dành cho M5. |
...
- Entry `Plugin`: bỏ qua (cho tới M5).
...
Thêm **`EntryKind`** mới: xem ⚠ mục 5.2 — hiện tại nó phá vỡ mọi runtime cũ.
